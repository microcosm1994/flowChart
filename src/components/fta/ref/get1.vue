<template>
  <el-card class="box-card" shadow="hover">
          ...
          <div class="search-box">
            <el-input placeholder="请输入搜索内容" v-model="searchContent" class="input-with-select" size="mini" @keyup.native.13="search">
              <el-select v-model="searchSelect" slot="prepend" placeholder="请选择">
             	<el-option label="源" value="from"></el-option>
             	<el-option label="目标" value="to"></el-option>
             	<el-option label="用户" value="uid"></el-option>
             	<el-option label="权重" value="weight"></el-option>
             	<el-option label="排序" value="order"></el-option>
    ...
    <el-table :data="tableData" border style="width: 100%" height="70vh">
      ...
      <el-table-column  prop="from"   label="源"> </el-table-column>
     	...
     	<el-row>
          <el-col :span="24">
            <el-form-item label="源">
              <el-input v-model="dialogData.from"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
     	<el-row>
          <el-col :span="24">
            <el-form-item label="目标">
              <el-input v-model="dialogData.to"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
     	<el-row>
     	...
     	<el-row>
          <el-col :span="24">
            <el-form-item label="权重">
              <el-input v-model="dialogData.weight"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
     	<el-row>
          <el-col :span="24">
            <el-form-item label="排序">
              <el-input v-model="dialogData.order"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
        ...
        if (id) {
          for (let i = 0; i < deviceData.length; i++) {
            if (id === deviceData[i].id) {
              ...
              this.$http.post('/api/fta/ref/get', {id: deviceData[i].$device_struct_ibfk_2, deleted: 0, n: 0, l: 100}).then((response) => {
                if (response.status === 200) {
          ...
          this.$http.post('/api/fta/ref/get', {deleted: 1, n: start, l: end}).then((response) => {
            if (response.status === 200) {
              this.tableData = response.data.d
              this.tableTotle = response.data.t
            }
