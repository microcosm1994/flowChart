<template>
  <el-form size="mini" :model="ruleForm" label-width="80px">
    ...
    <el-form-item label="节点" title="节点">
      <el-input v-model="ruleForm.api" disabled></el-input>
    </el-form-item>
    <el-form-item label="参数名" title="<固定>参数名">
      <el-input v-model="ruleForm.parameter" disabled></el-input>
    </el-form-item>
    <el-form-item label="参数值" title="<固定>参数值">
      <el-input v-model="ruleForm.value" disabled></el-input>
    </el-form-item>
    <el-form-item label="接口" title="接口">
      <el-input v-model="ruleForm.auto" disabled></el-input>
    </el-form-item>
