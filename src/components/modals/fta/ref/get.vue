<template>
  <el-form size="mini" :model="ruleForm" label-width="80px">
    <el-form-item label="源" title="源">
      <el-input v-model="ruleForm.from" disabled></el-input>
    </el-form-item>
    <el-form-item label="目标" title="目标">
      <el-input v-model="ruleForm.to" disabled></el-input>
    </el-form-item>
    <el-form-item label="权重" title="权重">
      <el-input v-model="ruleForm.weight" disabled></el-input>
    </el-form-item>
    <el-form-item label="排序" title="排序">
