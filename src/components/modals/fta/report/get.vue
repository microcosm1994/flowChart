<template>
  <el-form size="mini" :model="ruleForm" label-width="80px">
    <el-form-item label="日志编号" title="日志编号">
      <el-input v-model="ruleForm.id" disabled></el-input>
    </el-form-item>
    <el-form-item label="总分" title="总分">
      <el-input v-model="ruleForm.score" disabled></el-input>
    </el-form-item>
    <el-form-item label="故障树数据状态备份文件路径" title="故障树数据状态备份文件路径">
      <el-input v-model="ruleForm.jsonFilePath" disabled></el-input>
    </el-form-item>
