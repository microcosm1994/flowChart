<template>
  <el-form size="mini" status-icon :rules="rules" ref="ruleForm" :model="ruleForm" label-width="80px">
     <el-form-item label="总分" prop="score" title="总分">
      <el-input
        type="textarea"
        autosize
        placeholder="请输入内容"
   ...
   <el-form-item label="故障树数据状态备份文件路径" prop="jsonFilePath" title="故障树数据状态备份文件路径">
      <el-input v-model="ruleForm.jsonFilePath"></el-input>
    </el-form-item>
    <el-form-item>
