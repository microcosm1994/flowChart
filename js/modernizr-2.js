    ...
    var testBundle = (function( styles, tests ) {
        ...
        injectElementWithStyles(style, function( node, rule ) {
            var style = document.styleSheets[document.styleSheets.length - 1],
                ...
                // More here: github.com/Modernizr/Modernizr/issues/288 &
				// github.com/Modernizr/Modernizr/issues/293
            ...
            for ( var i = 0, bool, inputElemType, defaultView, len = props.length; i < len; i++ ) {
                ...
                if ( bool ) {
                    ...
                    if ( /^range$/.test(inputElemType) && inputElem.style.WebkitAppearance !== undefined ) {
                      ...
                      // Spec doesnt define any special parsing or detectable
						// UI
                      ...
                      bool = inputElem.checkValidity && inputElem.checkValidity() === false;
                        ...
                        // chuck into DOM and force reflow for Opera bug in
						// 11.00
      ...
      function shivDocument(ownerDocument) {
        ...
        if (html5.shivCSS && !supportsHtml5Styles) {
          shived = !!addStyleSheet(ownerDocument,
            ...
            // corrects 'hidden' attribute and audio[controls] display not
			// present in IE7/8/9
